...
'''
	Prepare UGem light curves for analysis.
...
def clproc(table,pshift=0.,plot=False):
	...
	T0 = 2452377.73365576 #2452748.38852796
...
def main(argv):
	...
	_path = os.path.expanduser('/Volumes/TiagoHD2/analise/UGem/')
	_file5 = 'ugem_0110070401_b50s_0310keV_pn_lc_net.ds'
